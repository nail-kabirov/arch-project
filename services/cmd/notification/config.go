...
type config struct {
	...
	DBName     string `envconfig:"db_name" default:"notification_db"`
	DBUser     string `envconfig:"db_user" default:"notification_user"`
	DBPassword string `envconfig:"db_password" default:"notification-pwd"`
