...
import (
	...
	"arch-homework/pkg/user/infrastructure/transport/authservice"
...
func startServer(
	...
	authSvcClient := authservice.NewClient(http.Client{}, cfg.AuthServiceHost)

	userService := app.NewUserService(dbDep, eventStore, authSvcClient)
